...
const {
    ...
    let up = `
    ╭──────────────⊷❒
*සාදරයෙන් පිලිගන්නවා ALEXA-MD වෙත:|🌸*
- *👧🏻 Alexa ඔබගේ ගිණුමේ දැන් සක්‍රියයි*
- *👧🏻 Alexa පිළිබද සම්පූර්ණ අවබෝධයක් ලබා ගැනීමට 📖 .alexa විධානය භාවිතා කරන්න...*
- *👧🏻 Alexa යනූ සීඝ්‍රයෙන් වර්ධනය වන Whatsapp රොබෝවෙකි..*
- *⚠️ මෙය ඔබගේ LOG අංකයයි.මෙහි විධාන භාවිතයෙන් වළකින්න.*
⁠⁠⁠⁠╰──────────────⊷❒
╭──────────────⊷❒
*ＡLEXA CONNECTED SUCCESSFULY 🚀*
- *👧🏻 Welcome to ALEXA MD*
- *👧🏻 ALEXA MD WORKING Your Account*
- *👧🏻 Use the 🚀 .alexa command to get a full understanding of the ALEXA MD testimonial...*
- *👧🏻 ALEXA MD is a powerfull WhatsApp robot developed by Sadeesha.*
...
│ *AUTO_VOICE_REPLY* : ${config.AUTO_VOICE}
